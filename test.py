...
because of Turing machine""")
        ...
        self.test_question5_answer1 = objects.Answer("Char", 1, "Char is not a python data type")
        self.test_question5_answer2 = objects.Answer("Integer", 0, "Integer is a python data type")
        self.test_question5_answer3 = objects.Answer("Float", 0, "Float is a python data type")
        self.test_question5_answer4 = objects.Answer("String", 0, "String is a python data type")
        self.test_question5_answer5 = objects.Answer("List", 0, "List is a python data type")
        self.test_question5_answer6 = objects.Answer("Dictionary", 0, "Dictionary is a python data type")
